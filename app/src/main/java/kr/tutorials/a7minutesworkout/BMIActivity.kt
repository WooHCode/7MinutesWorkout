...
import kr.tutorials.a7minutesworkout.databinding.ActivityBmiBinding
...
class BMIActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(supportActionBar!=null){
            ...
            supportActionBar?.title = "Calculated BMI"
        }
    ...
    private fun calculateUnits(){
        if(currentVisibleView == METRIC_UNITS_VIEW){
            if(validateMetricUnits()){
                ...
                Toast.makeText(this@BMIActivity,"Please enter a valid value",Toast.LENGTH_SHORT)
                    .show()
            }
        }else{
            if(validateUsUnits()){
